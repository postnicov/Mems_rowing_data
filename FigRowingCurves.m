...
%
%% Names
name{1}='Ульянчик'; % Ульянчик Влад 4 ступени
name{2}='Черкес'; % Черкес 4 ступени
name{3}='Кохно'; % Кохно 1я и 3я ступени
name{4}='Шпаковский'; % Шпаковский 4 ступени
name{5}='Гринцевич'; % Гринцевич 4 ступени
name{6}='Шоломицкий'; % Шоломицкий 5 ступеней
name{7}='Козляк'; % Козляк 4 ступени
% 
